...
and the test suite call :func:`validate`.
    ...
    python tools/validate_config.py           # exit 1 on any error
    python tools/validate_config.py --quiet   # errors only
