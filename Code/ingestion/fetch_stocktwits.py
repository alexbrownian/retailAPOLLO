...
Usage::
    ...
    python Code/ingestion/fetch_stocktwits.py
    python Code/ingestion/fetch_stocktwits.py --symbols GME,NVDA,GLD   # override the list
"""
...
OUT_DIR = os.path.join(DATA_DIR, "raw", "StockTwits")
