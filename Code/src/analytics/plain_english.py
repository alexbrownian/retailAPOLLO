...
reading a chart between meetings.  The rule is therefore:
...
USAGE
-----
    from src.analytics.plain_english import plain, relabel, glossary_md
...
# measured behaviour, recorded in `research.ipynb`: how many of
...
# names are abstracted with `***` but remain half-visible.
#
