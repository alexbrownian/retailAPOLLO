...
| `conditioning_sweep.json` | the 2026-08-09 operating-point conditioning study (smoothing vs F0.5 cut vs crossing trigger, 8 configs x 2 heads, walk-forward) — the evidence behind the crossing trigger and the dashboard's Strict setting |
