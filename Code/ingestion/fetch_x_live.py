...
Usage::
    ...
    python Code/ingestion/fetch_x_live.py --test   # one small call, writes nothing
    python Code/ingestion/fetch_x_live.py          # real poll (fetch_all calls this)
    python Code/ingestion/fetch_x_live.py --max-tweets 150
...
def main():
    ...
    print("raw accumulates here; merge into posts.parquet is the next pipeline "
          "step:  python Code/ingestion/merge_live.py")
    return 0
